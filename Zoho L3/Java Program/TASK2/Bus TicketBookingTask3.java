	...
	public static void main(String[] args)
{
	 ...
	 public static void display(ArrayList<Passenger>passengersList)
		{
				for(Passenger p : passengersList)
				{
					System.out.println("Passenger Id : " +p.passengerId +" Passenger name : "+p.passengername+"  Passenger age : "+p.age +"  Bus no : "+p.busno );
				}
	...
	public static void CancelTicket(int n, ArrayList<Passenger>passengersList){
		
		for(Passenger p:passengersList)
		{
			if(p.passengerId==n)
			{
				Passenger getpassenger=p;
