...
class BankingTransaction{
		...
		while(loop)
		{
			...
			switch(n)
			{
				case 1:
				{
					...
					//boolean verify=toVerify(s,BankUserDetails);
					scan.nextLine();
	...
	/*public static boolean toVerify(String name,ArrayList<User>BankUserDetails)
...
class User extends Thread{
	...
	void synchronized withdrawal(int amount)
	{
	...
	void synchronized deposit(int amount)
	{
		balance=balance+amount;
